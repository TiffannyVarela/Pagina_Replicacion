    ...
    */
    ...
    if (!extension_loaded('oci8')) {
        $oracle_error_msg = 'OCI8 extensiOn no instalada';
        ...
        try {
            ...
            if ($conn) {
                $oracle_online = true;
                $oracle_detalle = 'ConexiOn exitosa a Oracle';
    ...
    */
    ...
    $response = [
        ...
        //Fecha de última replicaciOn (string|null)
        'ultima_ejecucion' => $ultima_ejecucion,
        //Fecha/hora actual de la verificaciOn
        'timestamp' => date('Y-m-d H:i:s'),
        //InformaciOn de depuraciOn (host, puerto, servicio)
        '_debug' => [
